...
var forms = function forms(state) {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      e.preventDefault();
      var statusMessange = document.createElement('div');
...
var timer = function timer(id, deadline) {
  var getTimeRemaining = function getTimeRemaining(endtaim) {
    var t = Date.parse(endtaim) - Date.parse(new Date()),
  ...
  var setClock = function setClock(selector, endtaim) {
    ...
    function updateClock() {
      var t = getTimeRemaining(endtaim);
